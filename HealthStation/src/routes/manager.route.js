...
router.post('/product-management/create', upload.array('images', 5), managerController.postCreateProduct);
router.get('/product-management/:id', managerController.detailsProduct);
router.post('/product-management/:id',upload.array('images', 5), managerController.updateProduct);
